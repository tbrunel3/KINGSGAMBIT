...
Mesuré : **la campagne se traverse sans farmer une seule fois**, et elle finit
exactement aux niveaux qu'elle prête au joueur — Ch6 et casernes 6 pour la
dernière bataille, ce qu'annonce son `player: 6`.

**Deux chiffres à surveiller, pas un.** « Combien de replays » dit si la
campagne est trop chère ; « combien reste-t-il à la fin » dit si elle est trop
généreuse. Une hausse des deux dernières récompenses a été essayée puis
retirée : elle supprimait bien tout farm, mais laissait 33 593 or dormants sur
...
moins — mais un humain perd aussi plus de pièces, donc rachète davantage.
