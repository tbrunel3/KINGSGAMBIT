...
var promoted: bool = false  ## vrai pour un pion devenu Dame
...
## Promotion : un pion arrive au fond adverse devient une Dame de meme niveau.
func promote_to_queen() -> void:
	_apply_type(Balance.DAME)
	promoted = true
